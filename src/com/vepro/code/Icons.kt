...
object Icons {
    ...
    private val D: Map<String, String> = buildMap {
        ...
        put(
            "vpx",
            "M3 5h4l5 14 5-14h4l-7 18h-4z"
        )
        put(
            "github",
            "M12 2C6.48 2 2 6.58 2 12.25c0 4.54 2.87 8.39 6.84 9.75.5.1.68-.22.68-.49v-1.72c-2.78.62-3.37-1.21-3.37-1.21-.45-1.2-1.11-1.52-1.11-1.52-.91-.64.07-.63.07-.63 1 .08 1.53 1.05 1.53 1.05.9 1.58 2.37 1.12 2.95.86.09-.67.35-1.13.63-1.39-2.22-.26-4.56-1.15-4.56-5.11 0-1.13.39-2.05 1.03-2.78-.1-.26-.45-1.31.1-2.73 0 0 .84-.28 2.75 1.06A9.28 9.28 0 0 1 12 6.5c.85 0 1.71.12 2.51.35 1.91-1.34 2.75-1.06 2.75-1.06.55 1.42.2 2.47.1 2.73.64.73 1.03 1.65 1.03 2.78 0 3.97-2.35 4.85-4.58 5.1.36.32.68.93.68 1.87V21.5c0 .27.18.59.69.49A10.3 10.3 0 0 0 22 12.25C22 6.58 17.52 2 12 2z"
        )
